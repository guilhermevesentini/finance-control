...
import AdicionarDespesaController, { AdicionarDespesaControllerDi, type IAdicionarDespesaController } from '../../controller/AdiconarDespesaController';
...
const handleCriar = async (formEl: FormInstance | undefined) => {
  ...
  await formEl.validate(async (valid) => {
    if (valid) {
      ...
      const novaDespesa = adicionarDespesaController.criarDespesa(despesasDetails);
